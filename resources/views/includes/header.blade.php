...
<meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        ...
        <link href="{{ asset('/css/circular-std-style.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('/css/libs-style.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{ asset('/css/datepicker/tempusdominus-bootstrap-4.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('/css/inputmask.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('/css/form_styles.css')}}" rel="stylesheet" type="text/css" />
                            ...
                            <li class="nav-item active">
                                ...
                                <div id="submenu-1" class="collapse submenu">
                                    <ul class="nav flex-column">
                                        <li class="nav-item"><a href="{{url('/arrival/')}}" class = "nav-link">Arrivals</a></li>
                                        <li class="nav-item"><a href="{{url('/departure/')}}" class = "nav-link">Departures</a></li>
                                        <li class="nav-item"><a href="{{url('/stayingGuests/')}}" class = "nav-link">Staying Guests</a></li>
                                    </ul>
                                </div>
                            </li>
